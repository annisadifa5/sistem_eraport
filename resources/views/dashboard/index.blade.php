...
<!-- Font & Icons (paling dulu) -->
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">

<!-- Tailwind (baru setelah font) -->
<script src="https://cdn.tailwindcss.com"></script>

<!-- Alpine.js (setelah Tailwind, biar utility classnya kebaca) -->
<script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>

<!-- Chart.js (paling akhir dari semua library, karena nggak ngubah tampilan layout) -->
...
/* ===== Tambahan warna abu untuk input date & kategori ===== */
    ...
    /* Warna default teks select */
    select.input-box {
      color: #CDCDCD;
    }

    /* Saat user sudah pilih, ubah ke hitam */
    select.input-box:focus,
    select.input-box option:checked {
      color: black;
    }

    /* Trik untuk menampilkan placeholder abu saat value default (disabled) */
    select.input-box option[disabled] {
      color: #CDCDCD;
    }

 /* Kalau user sudah pilih tanggal, ubah warna teks jadi hitam */
input[type="date"]:not(:placeholder-shown) {
  color: #000;
}

/* Fix agar browser yang gak support :placeholder-shown tetap bisa */
...
>
 ...
 <div class="container">
  ...
  // pakai icon putih
  icon.innerHTML = '<i class="fa-solid fa-calendar text-white"></i>';
  ...
  // pakai icon putih
  icon.innerHTML = '<i class="fa-solid fa-bell text-white"></i>';
