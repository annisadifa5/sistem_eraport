...
<div class="p-6 bg-white rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Data Siswa Baru</h2>
    ...
    <form action="{{ route('siswa.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" id="tingkat" name="tingkat" value="{{ old('tingkat') }}" required
                       class="w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: X, XI, XII">
            </div>
            ...
            <div>
                ...
                <select id="id_ekskul" name="id_ekskul"
                    ...
                    @foreach ($ekskulList as $ekskul)
                        <option value="{{ $ekskul->id_ekskul }}" {{ old('id_ekskul') == $ekskul->id_ekskul ? 'selected' : '' }}>
                            {{ $ekskul->nama_ekskul }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" name="no_regis_akta_lahir" value="{{ old('no_regis_akta_lahir') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            {{-- Anak ke --}}
            <div>
                <label for="anak_ke_berapa" class="block text-sm font-medium text-gray-700 mb-1">Anak Ke-berapa</label>
                <input type="number" name="anak_ke_berapa" value="{{ old('anak_ke_berapa') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            {{-- Jumlah Saudara --}}
            <div>
                <label for="jml_saudara_kandung" class="block text-sm font-medium text-gray-700 mb-1">Jml. Saudara Kandung</label>
                <input type="number" name="jml_saudara_kandung" value="{{ old('jml_saudara_kandung') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            ...
            <div class="md:col-span-4 mt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="md:col-span-4">
                        ...
                        <textarea name="alamat" rows="2" class="w-full border border-gray-300 rounded-md shadow-sm">{{ old('alamat') }}</textarea>
                    </div>
                    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="p-4 border border-gray-200 rounded-md bg-gray-50">
                ...
                <div>
                    ...
                    <input type="text" name="nama_ayah" value="{{ old('nama_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">NIK Ayah</label>
                    <input type="text" name="nik_ayah" value="{{ old('nik_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tahun Lahir</label>
                    <input type="number" name="tahun_lahir_ayah" value="{{ old('tahun_lahir_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pendidikan</label>
                    <input type="text" name="jenjang_pendidikan_ayah" value="{{ old('jenjang_pendidikan_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan</label>
                    <input type="text" name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Penghasilan</label>
                    <input type="text" name="penghasilan_ayah" value="{{ old('penghasilan_ayah') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
            ...
            <div class="p-4 border border-gray-200 rounded-md bg-gray-50">
                ...
                <div>
                    ...
                    <input type="text" name="nama_ibu" value="{{ old('nama_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                 <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">NIK Ibu</label>
                    <input type="text" name="nik_ibu" value="{{ old('nik_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tahun Lahir</label>
                    <input type="number" name="tahun_lahir_ibu" value="{{ old('tahun_lahir_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pendidikan</label>
                    <input type="text" name="jenjang_pendidikan_ibu" value="{{ old('jenjang_pendidikan_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan</label>
                    <input type="text" name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Penghasilan</label>
                    <input type="text" name="penghasilan_ibu" value="{{ old('penghasilan_ibu') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
            ...
            <div class="p-4 border border-gray-200 rounded-md bg-gray-50">
                ...
                <div>
                    ...
                    <input type="text" name="nama_wali" value="{{ old('nama_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">NIK Wali</label>
                    <input type="text" name="nik_wali" value="{{ old('nik_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tahun Lahir</label>
                    <input type="number" name="tahun_lahir_wali" value="{{ old('tahun_lahir_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pendidikan</label>
                    <input type="text" name="jenjang_pendidikan_wali" value="{{ old('jenjang_pendidikan_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan</label>
                    <input type="text" name="pekerjaan_wali" value="{{ old('pekerjaan_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm mb-2">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Penghasilan</label>
                    <input type="text" name="penghasilan_wali" value="{{ old('penghasilan_wali') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" name="no_kps" value="{{ old('no_kps') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
             {{-- KIP --}}
            <div>
                ...
                <select name="penerima_kip" class="w-full border border-gray-300 rounded-md shadow-sm">
                    <option value="0" {{ old('penerima_kip') == '0' ? 'selected' : '' }}>TIDAK</option>
                    <option value="1" {{ old('penerima_kip') == '1' ? 'selected' : '' }}>YA</option>
                </select>
            </div>
            <div>
                <label for="no_kip" class="block text-sm font-medium text-gray-700 mb-1">No. KIP</label>
                <input type="text" name="no_kip" value="{{ old('no_kip') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>

            {{-- Fisik & Transportasi --}}
            <div>
                <label for="tb" class="block text-sm font-medium text-gray-700 mb-1">Tinggi Badan (cm)</label>
                <input type="number" name="tb" value="{{ old('tb') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                <label for="bb" class="block text-sm font-medium text-gray-700 mb-1">Berat Badan (kg)</label>
                <input type="number" name="bb" value="{{ old('bb') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                <label for="alat_transportasi" class="block text-sm font-medium text-gray-700 mb-1">Alat Transportasi</label>
                <input type="text" name="alat_transportasi" value="{{ old('alat_transportasi') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
                <label for="jarak_rumah" class="block text-sm font-medium text-gray-700 mb-1">Jarak Rumah (km)</label>
                <input type="text" name="jarak_rumah" value="{{ old('jarak_rumah') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            
             {{-- Sisanya --}}
            <div class="md:col-span-2">
                <label for="sekolah_asal" class="block text-sm font-medium text-gray-700 mb-1">Sekolah Asal</label>
                <input type="text" name="sekolah_asal" value="{{ old('sekolah_asal') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
            <div class="md:col-span-2">
                <label for="kebutuhan_khusus" class="block text-sm font-medium text-gray-700 mb-1">Kebutuhan Khusus</label>
                <input type="text" name="kebutuhan_khusus" value="{{ old('kebutuhan_khusus') }}" class="w-full border border-gray-300 rounded-md shadow-sm">
            </div>
        </div>
